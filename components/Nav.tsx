const Nav = () => {
  return (
    <>
      <nav className="bg-purple-500 sticky top-0 h-screen flex flex-col justify-between">
        <ul className="list-style-none p-0 mx-8 mt-11 flex items-center justify-center">
          <li>
            <a href="/">Projects</a>
          </li>
          <li>
