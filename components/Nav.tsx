...
const L = ({ children, className = "", href, ...props }: any) => {
  ...
  return (
    <li className={`${className} ${isCurrentPath ? "current" : ""}`}>
...
const Nav = () => {
  return (
    <>
      <nav className="bg-black sticky top-0 w-full h-[64px] md:w-[64px] md:h-screen flex md:flex-col justify-between z-[999]">
