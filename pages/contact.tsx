...
const Contact: NextPage = () => {
  return (
    <Layout title="Contact" description="" className="w-full overflow-x-hidden">
      <FadeUp>
        {" "}
        <div className="w-full pt-5 sm:pt-20 ml-5 sm:ml-10 h-[50vh]">
          <h1 className="sm:mt-5 md:mt-20 font-bold text-6xl sm:text-8xl mb-[10%]">
            Contact
          </h1>
          <div className="ml-5">
            <h3 className="text-3xl sm:mt-20">Reach out to me on:</h3>
